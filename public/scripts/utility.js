...
var uninspirationalQuotes = [
    ...
    "If you put an inspirational quote under your selfie no one can see your narcissism...",
...
function pickRandomAtInterval(arrayToPickFrom, intervalAmount, intervalUnit, jQuerySelector) {
    ...
    setInterval(function () {
        ...
        if (jQuerySelector) {
            ...
            $('#quote').append(pickRandom(arrayToPickFrom));
        }
...
var imageLinks = [
    ...
    "./images/miscAngry/10.gif",
    "./images/miscAngry/11.gif",
    "./images/miscAngry/12.gif",
    "./images/miscAngry/13.gif",
    "./images/miscAngry/14.gif",
    "./images/miscAngry/15.gif",
    "./images/miscAngry/16.gif",
    "./images/miscAngry/17.gif",
    "./images/miscAngry/18.gif",
    "./images/miscAngry/19.gif",
    "./images/miscAngry/20.gif",
    "./images/miscAngry/21.gif",
    "./images/miscAngry/22.png",
    "./images/miscAngry/23.gif",
];
